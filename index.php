...
<header id="header" class="fixed-top d-flex align-items-center">
    <div class="container d-flex justify-content-between">
      ...
      <div class="logo">
        <h1><a href="index.html"><span>Astra</span>honda</a></h1>
            ...
            <div class="footer-content">
              <div class="footer-head">
                <div class="footer-logo">
                  <h2><span>Astra</span>Honda</h2>
                </div>

                <p>Kualitas terbaik<div class="footer-icons">
                  <ul>
                    <li>
        ...
        <div class="row">
          <div class="col-md-12 col-sm-12 col-xs-12">
            <div class="copyright text-center">
              <p>
                &copy; Copyright <strong>Astra Honda</strong>. All Rights Reserved
              </p>
            </div>
            <div class="credits">
              <!--
            ...
            -->
              Designed by <a href="https://bootstrapmade.com/">M ahsan Jiddan dermawan</a>
            </div>
          </div>
        </div>
      </div>
